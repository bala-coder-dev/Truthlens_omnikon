...
📖 Overview
As synthetic media generation advances, distinguishing authentic captures from generated deepfakes requires more than simple binary classifiers. 
TruthLens delivers an explainable forensic auditing suite combining:
